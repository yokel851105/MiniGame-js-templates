...
#1.cocos creator complie Wechat Game to Wechat_devtoolsWebPack_Demo/   python publish_android.py
os.system('/Applications/CocosCreator.app/Contents/MacOS/CocosCreator --path ../MiniGame-templates/ --build "platform=android;debug=false;md5Cache=true;zipCompressJs=true;packageName=com.mzgame.webpack;"');
