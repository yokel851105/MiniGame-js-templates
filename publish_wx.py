...
#1.cocos creator complie Wechat Game to Wechat_devtoolsWebPack_Demo/     python publish_wx.py
os.system('/Applications/CocosCreator.app/Contents/MacOS/CocosCreator --path ../MiniGame-templates/ --build "platform=wechatgame;debug=false;md5Cache=true;zipCompressJs=true;appid=wx6ac3f5090a6b99c5;orientation=landscape"');
